        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-slate-200 dark:border-slate-700">
              <Link href="/" className={getLinkClassName('/', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')}>
                홈
              </Link>
              <Link href="/getting-started" className={getLinkClassName('/getting-started', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')}>
                시작하기
              </Link>
              <Link href="/usage-guide" className={getLinkClassName('/usage-guide', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')}>
                사용법 가이드
              </Link>
              <Link href="/tutorials" className={getLinkClassName('/tutorials', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')}>
                튜토리얼
              </Link>
              <Link href="/community" className={getLinkClassName('/community', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')}>
                커뮤니티
              </Link>
              <Link href="/use-cases" className={getLinkClassName('/use-cases', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')}>
                활용 사례
              </Link>
