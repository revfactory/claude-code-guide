        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-slate-200 dark:border-slate-700">
              <Link href="/" className={getLinkClassName('/', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')} onClick={handleLinkClick}>
                홈
              </Link>
              <Link href="/getting-started" className={getLinkClassName('/getting-started', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')} onClick={handleLinkClick}>
                시작하기
              </Link>
              <Link href="/usage-guide" className={getLinkClassName('/usage-guide', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')} onClick={handleLinkClick}>
                사용법 가이드
              </Link>
              <Link href="/tutorials" className={getLinkClassName('/tutorials', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')} onClick={handleLinkClick}>
                튜토리얼
              </Link>
              <Link href="/community" className={getLinkClassName('/community', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')} onClick={handleLinkClick}>
                커뮤니티
              </Link>
              <Link href="/use-cases" className={getLinkClassName('/use-cases', 'block px-3 py-2 rounded-md text-base font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors')} onClick={handleLinkClick}>
                활용 사례
              </Link>
              <a href="https://github.com/revfactory/claude-code-guide" target="_blank" rel="noopener noreferrer" className="flex items-center px-3 py-2 rounded-md text-base font-medium text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors" onClick={handleLinkClick}>
