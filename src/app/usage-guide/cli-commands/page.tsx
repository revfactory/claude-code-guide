                  ...
                  <div className="space-y-3">
                    <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-4">
                      ...
                      <div className="bg-slate-900 dark:bg-slate-800 rounded p-2 mb-2">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-slate-400 text-xs">Claude Code</span>
                          <CopyButton text="/model claude-sonnet-4-20250514" className="scale-75" />
                        </div>
                        <code className="text-blue-400 font-mono text-sm">claude{`>`} </code>
                        <code className="text-white font-mono text-sm">/model claude-sonnet-4-20250514</code>
                      </div>
                      <p className="text-slate-600 dark:text-slate-300 text-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-4">
                      ...
                      <div className="bg-slate-900 dark:bg-slate-800 rounded p-2 mb-2">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-slate-400 text-xs">터미널</span>
                          <CopyButton text='claude --model claude-sonnet-4-20250514 \"디버깅을 도와줘\"' className="scale-75" />
                        </div>
                        <code className="text-green-400 font-mono text-sm">claude --model claude-sonnet-4-20250514 "디버깅을 도와줘"</code>
                      </div>
                      <p className="text-slate-600 dark:text-slate-300 text-sm">
                ...
                <div>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-4">
                    ...
                    <div className="bg-slate-900 dark:bg-slate-800 rounded p-2 mb-2">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-slate-400 text-xs">터미널</span>
                        <CopyButton text="export ANTHROPIC_MODEL=claude-sonnet-4-20250514" className="scale-75" />
                      </div>
                      <code className="text-green-400 font-mono text-sm">export ANTHROPIC_MODEL=claude-sonnet-4-20250514</code>
                    </div>
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-300">
                      ...
                      <ul className="space-y-1 ml-4">
                        <li>• claude-sonnet-4-20250514 (권장)</li>
